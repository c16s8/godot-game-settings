...
## [method GGSInputUtils.event_get_glyph] for more info.
...
const JOYPAD_AXIS: Dictionary = {
	GGSInputUtils.Axis.LS_LEFT: "lstick_left",
	GGSInputUtils.Axis.LS_RIGHT: "lstick_right",
	GGSInputUtils.Axis.LS_UP: "lstick_up",
	GGSInputUtils.Axis.LS_DOWN: "lstick_down",
	GGSInputUtils.Axis.RS_LEFT: "rstick_left",
	GGSInputUtils.Axis.RS_RIGHT: "rstick_right",
	GGSInputUtils.Axis.RS_UP: "rstick_up",
	GGSInputUtils.Axis.RS_DOWN: "rstick_down",
	GGSInputUtils.Axis.LT: "left_trigger",
	GGSInputUtils.Axis.RT: "right_trigger",
}
